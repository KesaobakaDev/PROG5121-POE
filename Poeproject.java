...
public class Poeproject {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== PROG5121 POE - Registration & Login System ===\n");
        ...
        while (true) {
            ...
            if (choice.equals("1")) {
                ...
                boolean success = loginUser(storedUsername, storedPassword, loginUsername, loginPassword);
                System.out.println("\n" + returnLoginStatus(success, storedFirstName, storedLastName));
